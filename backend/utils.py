...
class CSVLogger_my: #save data into csv file
...
def score(y_true, y_pred):    #calculates metrics

    if isinstance(y_true, torch.Tensor):
        y_true = y_true.detach().cpu().numpy() #converts to numpy bcoz sklearn metrics use numpy arrays.
    else:
