...
class AntiModelIinitial():   #init wts of NN layers
 ...
 #linear nrmlized bw 0 & 0.02 random vals
 #bias =0
 #embedding around 0
 #padding 0
 #Layernorm usually behaves nrml having wt=1 and bias=0
 #does not return anything directly modifies the weights and bias in layer
